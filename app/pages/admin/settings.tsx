...
import { Save, Bell, Globe, Database, Server, Calendar, Type } from 'lucide-react'
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              <div>
                ...
                <p className='text-xs text-slate-400 mt-2'>
                  Tên này sẽ hiển thị trên tiêu đề tab trình duyệt và trang đăng nhập.
                </p>
              </div>
              ...
              <div>
                ...
                <SelectRoot
                  collection={createListCollection({
                    items: [
                      { label: 'Năm học 2024-2025, Học kỳ 1', value: '2024-2025-HK1' },
                      { label: 'Năm học 2024-2025, Học kỳ 2', value: '2024-2025-HK2' },
                      { label: 'Năm học 2024-2025, Học kỳ Hè', value: '2024-2025-HK3' }
                    ]
                  })}
                  value={currentTerm ? [currentTerm] : []}
                  onValueChange={(e: any) => setCurrentTerm(e.value[0] || '')}
                  size='md'
                  variant='outline'
                  positioning={{ sameWidth: true }}
                >
                  <SelectTrigger>
                    <SelectValueText placeholder='Chọn học kỳ' />
                  </SelectTrigger>
                  <SelectContent>
                    {[
                      { label: 'Năm học 2024-2025, Học kỳ 1', value: '2024-2025-HK1' },
          ...
          <div className='p-8 space-y-6'>
            <div className='flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:border-slate-200 transition-colors'>
              <div>
                ...
                <p className='text-xs text-slate-500 mt-1'>
                  Khi bật, chỉ Admin mới có thể truy cập hệ thống. Người dùng khác sẽ thấy trang bảo trì.
                </p>
              </div>
            ...
            <div className='flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:border-slate-200 transition-colors'>
              <div>
                ...
                <p className='text-xs text-slate-500 mt-1'>
                  Sinh viên có thể tự do đăng ký hoặc hủy học phần trong thời gian này.
                </p>
              </div>
              <label className='relative inline-flex items-center cursor-pointer'>
                <input
          ...
          <section className='bg-white rounded-2xl shadow-sm border border-slate-200'>
            ...
            <div className='p-6'>
              <p className='text-sm text-slate-600 mb-6 leading-relaxed'>
                Cấu hình gửi email tự động từ hệ thống thông qua Amazon SES. Quản lý template cho các loại email: Reset
                Password, Thông báo lớp học...
              </p>
